...
const CountingSection = () => {
  ...
  return (
    <div className="grid mt-[17rem]">
            ...
            title={
              <>
                ...
                <div className="flex items-center gap-2">
                  <div className="text-[27px]">Signatories and counting in</div>
                  <div className="bg-primaryColor rounded-full px-3 py-1 text-white text-[18px] whitespace-nowrap">
                    D! UK
                  </div>
                </div>
              </>
      ...
      {/* Signatories list */}
      <div className="text-textColor mt-20">
